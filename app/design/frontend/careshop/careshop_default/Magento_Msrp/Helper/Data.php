 ...
 */
namespace careshop\careshop_default\Magento_Msrp\Helper;
...
class Data extends AbstractHelper
{
    ...
    public function isMinimalPriceLessMsrp($product)
    {
     ...
     public function getBrandImage($productId) {
      ...
      //   $eav_attribute_option_swatch = $this->_resource->getTableName('eav_attribute_option_swatch');
      //   $query = "SELECT `value` FROM `$eav_attribute_option_swatch` WHERE `option_id` = $brandId";
