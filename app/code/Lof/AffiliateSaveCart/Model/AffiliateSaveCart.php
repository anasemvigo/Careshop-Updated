...
use Lof\AffiliateSaveCart\Api\Data\AffiliateSaveCartInterface;
use Lof\AffiliateSaveCart\Api\AffiliateSaveCartRepositoryInterface;

/**
 * AffiliateSaveCart model
 *
 */
class AffiliateSaveCart extends \Magento\Framework\Model\AbstractModel implements AffiliateSaveCartInterface
{
     ...
     * @var string
     */
    protected $_eventPrefix = 'lof_affiliatesavecart_savecart';
    ...
    {
        $this->_init('Lof\AffiliateSaveCart\Model\ResourceModel\AffiliateSaveCart');
    }
    ...
    {
        return $this->_getData(self::QUOTE_ITEMS);
    }

    /**
     * @inheritdoc
     */
    public function setQuoteItems($quoteItems)
    {
        return $this->setData(self::QUOTE_ITEMS, $quoteItems);
    }
