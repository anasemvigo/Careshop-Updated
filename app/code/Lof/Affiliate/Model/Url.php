...
class Url
{
     ...
     */
    const ROUTE_AFFILIATE_ACCOUNT_LOGIN = 'affiliate/account/login';
    ...
    {
        return $this->urlBuilder->getUrl(self::ROUTE_AFFILIATE_ACCOUNT_LOGIN, $this->getLoginUrlParams());
    }
    ...
    public function getLoginPostUrl()
    {
        ...
        return $this->urlBuilder->getUrl('affiliate/account/loginPost', $params);
    }
    ...
    {
        return $this->urlBuilder->getUrl('affiliate/account/logout');
    }
    ...
    {
        return $this->urlBuilder->getUrl('affiliate/account/create');
    }
    ...
    {
        return $this->urlBuilder->getUrl('affiliate/account/createpost');
    }
    ...
    {
        return $this->urlBuilder->getUrl('affiliate/account/edit');
    }
    ...
    {
        return $this->urlBuilder->getUrl('affiliate/account/editpost');
    }
    ...
    {
        return $this->urlBuilder->getUrl('affiliate/account/forgotpassword');
    }
    ...
    {
        return $this->urlBuilder->getUrl('affiliate/account/confirmation', ['email' => $email]);
    }

    public function getCheckEmailUrl()
    {
        return $this->urlBuilder->getUrl('affiliate/account/checkaccountexist');
    }
}
