...
class BannerAffiliateActions extends Column
{
    /** Url path */
    const MENU_URL_PATH_EDIT = 'affiliate/banneraffiliate/edit';
    const MENU_URL_PATH_DELETE = 'affiliate/banneraffiliate/delete';
