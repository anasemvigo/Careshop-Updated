...
class Edit extends \Magento\Backend\App\Action
{
    ...
    {
        return $this->_authorization->isAllowed('Lof_Affiliate::campaign_edit');
    }
    ...
    protected function _initAction()
    {
        ...
        $resultPage->setActiveMenu('Lof_Affiliate::campaign_settings')
            ->addBreadcrumb(__('Affiliate Campaign'), __('Affiliate Campaign'))
            ->addBreadcrumb(__('Manage Affiiate Campaign'), __('Manage Affiiate Campaign'));
        return $resultPage;
    }
    ...
    public function execute()
    {
        ...
        $resultPage->addBreadcrumb(
            $id ? __('Edit Affiliate Campaign') : __('New Affiliate Campaign'),
            $id ? __('Edit Affiliate Campaign') : __('New Affiliate Campaign')
        );
        $resultPage->getConfig()->getTitle()->prepend(__('Affiliate'));
        $resultPage->getConfig()->getTitle()
            ->prepend($model->getId() ? $model->getName() : __('New Affiliate Campaign'));
