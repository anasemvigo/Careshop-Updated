...
class Withdraw extends \Magento\Catalog\Controller\Adminhtml\Product
{
    ...
    public function execute()
    {
        ...
        $pagesGrid = $layout->createBlock(
            'Lof\Affiliate\Block\Adminhtml\AccountAffiliate\Edit\Tab\Withdraw',
            '',
            ['data' => []]
        );
    ...
    {
        return $this->_authorization->isAllowed('Lof_Affiliate::account_withdraw');
    }
}