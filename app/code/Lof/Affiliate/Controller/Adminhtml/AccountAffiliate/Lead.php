...
class Lead extends \Magento\Catalog\Controller\Adminhtml\Product
{
    ...
    public function execute()
    {
        ...
        $pagesGrid = $layout->createBlock(
            'Lof\Affiliate\Block\Adminhtml\AccountAffiliate\Edit\Tab\Lead',
            '',
            ['data' => []]
        );
    ...
    {
        return $this->_authorization->isAllowed('Lof_Affiliate::account_lead');
    }
}